...
const RecruiterSubscriptions = () => {
  ...
  return (
    <section id="subscriptions" className="py-20 px-6 bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-10">
          Choose the perfect plan to match your hiring needs. Save <span className="font-semibold text-green-600">20%</span> by choosing a longer plan.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <motion.div
              key={index}
              className={`p-8 ${plan.bgColor} border-2 ${plan.color} rounded-lg shadow-md transform hover:scale-105 transition duration-300`}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <span className="text-lg text-gray-600">/{billingKey === "monthly" ? "month" : billingKey === "quarterly" ? "3months" : "year"}</span>
                </motion.p>
              </AnimatePresence>
