...
export default function SignupForm() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open("https://new-repo-admin.vercel.app/", "_blank")
      ...
      <div className="flex justify-between items-center mb-6">
        {[1, 2, 3, 4].map((stepNumber) => (
          <div key={stepNumber} className="flex flex-col items-center">
            ...
            >
              {step > stepNumber ? <Check size={16} className="sm:size-20" /> : stepNumber}
            </div>
            <span
              className={`text-xs mt-2 ${step >= stepNumber ? "text-blue-600 font-medium" : "text-gray-500"} hidden sm:block`}
            >
              {stepNumber === 1
                ? "Personal"
                : stepNumber === 2
  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-5 bg-gray-50">
      <div className="w-full max-w-7xl p-4 sm:p-6 md:p-8 bg-white shadow-lg rounded-xl">
        <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex justify-between mt-8">
          {step > 1 ? (
            <button
              type="button"
              className="px-3 py-2 sm:px-6 sm:py-3 border border-gray-300 rounded-lg text-gray-700 text-sm sm:text-base font-medium hover:bg-gray-50 transition-colors"
              onClick={prevStep}
            >
              Previous
            </button>
          ...
          {step < 4 ? (
            <div className="flex gap-2 sm:gap-3">
              ...
              <button
                type="button"
                className="px-3 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg text-sm sm:text-base font-medium hover:from-blue-600 hover:to-blue-700 transition-colors shadow-md"
                onClick={nextStep}
              >
                Next
              </button>
            ...
            <div className="flex gap-2 sm:gap-3">
              ...
              <button
                type="button"
                className="px-3 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg text-sm sm:text-base font-medium hover:from-green-600 hover:to-green-700 transition-colors shadow-md"
